...
import com.aim.config.security.core.*;
import com.aim.config.security.service.DefaultFilterSecurityInterceptor;
import com.aim.config.security.service.UserDetailServices;
...
@Configuration
@EnableWebSecurity
@ComponentScan("com.aim.config.security")
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.exceptionHandling().authenticationEntryPoint(new DefaultLoginUrlEntryPoint("/login"))
                ...
                .antMatchers("/assets/**", "/static/**", "/html/**", "/swagger-resources/**", "swagger-ui.html",
                        "/webjars/**", "/favicon.ico", "/", "/index", "/login", "/admin/login", "/login_check").permitAll()
